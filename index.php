...
<div class="content">
          ...
          <div class="row row-deck row-cards">
            ...
            <div class="col-sm-6 col-xl-3">
              <div class="card card-sm">
                <div class="card-body d-flex align-items-center">
                  <div class="mr-3">
                    <div class="chart-sparkline chart-sparkline-square" id="sparkline-55"></div>
                  </div>
                  <div class="mr-3 lh-sm">
                    <div class="strong">
                      1,352 Members
            ...
            <div class="col-sm-6 col-xl-3">
              <div class="card card-sm">
                <div class="card-body d-flex align-items-center">
                  ...
                  <div class="ml-auto">
                    <div class="chart-sparkline chart-sparkline-square" id="sparkline-56"></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="table-responsive">
                  <table class="table card-table table-vcenter">
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <div class="chart-sparkline" id="sparkline-57"></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-55').text("56/100").peity("pie", {
      		width: 40,
      		height: 40,
      		stroke: "#cd201f",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-56').text("22/100").peity("pie", {
      		width: 40,
      		height: 40,
      		stroke: "#fab005",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-57').text("17, 24, 20, 10, 5, 1, 4, 18, 13").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-58').text("13, 11, 19, 22, 12, 7, 14, 3, 21").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-59').text("10, 13, 10, 4, 17, 3, 23, 22, 19").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-60').text("9, 6, 14, 11, 8, 24, 2, 16, 15").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
